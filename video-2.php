...
<div class="container">
    <div class="site-main">
        ...
        <div class="video-section_title" style="margin-top:60px;">基調講演</div>
        
        <div style="padding:56.25% 0 0 0;position:relative; margin-top:20px;"><iframe src="https://player.vimeo.com/video/1010279727?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479#t=24m55s" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="基調講演"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
 ...
 <!-- ダウンロードボタン -->
        ...
        <div class="modal__inner" style="padding: 0 20px;">
            <div class="modal__box">
                ...
                <h2 class="modal-title" style="margin-top: 100px;">データ連係基盤の統合／拡大、データマネジメントへ</h2>
                ...
                <p class="modal-description">当社では、クラウドシフトや運用効率化を目的に、データ連係基盤の最適化／インフォマティカへの『統合』を進めると共に、利用者の『拡大』を狙った多角的な取組み（教育／周知／性能改善）を行っております。本講演では、『統合』『拡大』に、中長期的なDX施策として『データマネジメント』へのチャレンジをキーワードに加え、取組み事例／苦労等を発表致します。</p>
            </div>
        </div><!--modal__inner-->
