...
<div class="container">
    <div class="site-main">
        ...
        <div style="padding:56.25% 0 0 0;position:relative; margin-top:80px;">
            <iframe src="https://player.vimeo.com/video/1009874757?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="データ活用の課題と最新動向-現場で広げるデータの利活用とは"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
        
 <!-- ダウンロードボタン -->
 <a href="assets/pdf/IWT2024_NSW.pdf" class="download-button">セッション講演資料</a>
        
        <div class="modal__inner" style="padding: 0 20px;">
            <div class="modal__box">
               
                <h2 class="modal-title" style="margin-top: 100px;">データ活用の課題と最新動向　現場で広げるデータの利活用とは</h2>
                    ...
                    <div class="modal-member">
                        <div class="member-table">
                            ...
                            <div class="member-cell">
                                <h3>NSW株式会社</h3>
                                <p>サービスソリューション事業本部<br>クラウドプラットフォーム事業部<br>副事業部長<span>鈴木 輝亮 氏</span></p>
                            </div>
                    </div>
                </div>
