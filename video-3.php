...
<div class="container">
    <div class="site-main">
        ...
        <div class="video-section_title" style="margin-top:60px;"></div>
        
        <div style="padding:56.25% 0 0 0;position:relative; margin-top:80px;"><iframe src="https://player.vimeo.com/video/1010269544?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="AI時代の勝者へ：IDMCで実現するデータマネジメント"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
        ...
        <div class="modal__inner" style="padding: 0 20px;">
            <div class="modal__box">
                ...
                <h2 class="modal-title" style="margin-top: 100px;">AI時代の勝者へ：IDMCで実現するデータマネジメント</h2>
