    ...
    <body class="site drawer drawer--left">
        ...
        <div class="site-main">
            ...
            <div class="profileform-container">
                ...
                <form id="privacyForm"
                    action="profile.php?utm_source=<?php echo urlencode($utm_source); ?>&utm_medium=<?php echo urlencode($utm_medium); ?>&utm_campaign=<?php echo urlencode($utm_campaign); ?>"
                    method="post">
                    ...
                    <input type="hidden" name="sessions[]"
                        value="<?php echo htmlspecialchars($session, ENT_QUOTES, 'UTF-8'); ?>">
                    <?php endforeach; ?>
                    <?php else: ?>
                    <div class="display-none">
                        <p>選択した講演がありません。</p>
                    ...
                    <div class="bottom-button">
                        <div class="select-btn-box">
                            <a href="index.php?utm_source=<?php echo urlencode($utm_source); ?>&utm_medium=<?php echo urlencode($utm_medium); ?>&utm_campaign=<?php echo urlencode($utm_campaign); ?>"
                                class="select-btn-2">セッション選択へ戻る</a>
