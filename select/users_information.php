...
if (isset($_GET['download'])) {
    ...
    // ヘッダー行の出力
    fputcsv($output, ['ログインID', '姓', '名', '法人種別', '法人プレフィックス', '会社名', '電話番号', 'メールアドレス', '参加', '備考', 'ミニA1', 'A1備考', 'ミニA2', 'A2備考', 'ミニA3', 'A3備考', 'ミニB1', 'B1備考', 'ミニB2', 'B2備考', '作成日']);
...
<form method="get" action="">
            <button type="submit" name="download" value="1">CSVダウンロード</button>
        </form>
    </div>
    <div class="container">
        <h1>ユーザー出席情報</h1>
