...
// 管理者新規登録ページへのアクセスを保護するためのパスワード
$access_password = 'a01310805Aseed-brain';

// パスワード認証が必要
if (!isset($_SESSION['admin_register_access_granted'])) {
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['access_password'])) {
        if ($_POST['access_password'] === $access_password) {
            $_SESSION['admin_register_access_granted'] = true;
        } else {
            $error_message = 'アクセスパスワードが間違っています。';
        }
    } else {
        // アクセスパスワード入力フォームを表示
        echo '<form method="post">
                <h1>アクセスパスワードを入力</h1>
                <label for="access_password">アクセスパスワード:</label>
    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="button-container">
                ...
                <a href="adminLogin.php" class="admin-button">管理者ログイン</a>
            </div>
        </form>
