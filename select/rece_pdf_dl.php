...
$pdf->Cell($maxWidth, 0, $company, 0, 0, 'C');
    ...
    // 氏名を追加
    $pdf->SetFont("meiryob01", '', 30);
    $pdf->MultiCell(85, 0, htmlspecialchars($user['surname'], ENT_QUOTES, 'UTF-8') . ' ' . htmlspecialchars($user['given_name'], ENT_QUOTES, 'UTF-8'), 0, "C", false, 0, 10, 110);
