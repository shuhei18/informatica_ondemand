...
<div class="container">
    <div class="site-main">
        ...
        <div style="padding:56.25% 0 0 0;position:relative; margin-top:80px;"><iframe src="https://player.vimeo.com/video/1009875485?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="SUBARU流 全社データ活用で笑顔を作る「モノづくり革新」と「価値づくり」"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
        
 <!-- ダウンロードボタン -->
 <a href="assets/pdf/IWT2024_SUBARU.pdf" class="download-button">セッション講演資料</a>
        
        <div class="modal__inner" style="padding: 0 20px;">
            <div class="modal__box">
               
                <h2 class="modal-title" style="margin-top: 100px;">SUBARU流 全社データ活用で笑顔を作る「モノづくり革新」と「価値づくり」</h2>
